  ...
  return (
    <div className="max-w-xl mx-auto mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-500 mt-2">Send money securely to any Horizon Bank account</p>
      </div>
      ...
      <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden">
        {success && (
          <div className="absolute inset-0 bg-emerald-500 z-10 flex flex-col items-center justify-center text-white animate-in zoom-in duration-300">
            ...
            <p className="text-emerald-50">Redirecting to dashboard...</p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all font-mono"
                value={formData.toAccountNumber}
                onChange={e => setFormData({...formData, toAccountNumber: e.target.value.toUpperCase()})}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                step="0.01"
                placeholder="0.00"
                className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all font-medium text-lg"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2">Description <span className="text-slate-400 font-normal">(Optional)</span></label>
            <textarea 
              rows={2}
          ...
          <div className="pt-2">
            <button 
              type="submit" 
              disabled={loading || !formData.toAccountNumber || !formData.amount}
            ...
            >
              {loading ? (
                ...
                <><span>Send Transfer</span><ArrowRight size={18} /></>
              )}
            </button>
          </div>
        </form>
